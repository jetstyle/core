...
class Pager implements PagerInterface
{
    ...
    protected function construct()
    {
     ...
     protected function buildPage($i, $p, $start_from)
     {
        ...
        $urlParams = array_merge($urlParams, $this->keepVars);
         $page = array (
                    'num' => $i,
    ...
    /**
     * @param $keepVars - array of get params to keep in pager (filter vars for example)
     */
    public function setKeepVars($keepVars)
    {
        foreach ($keepVars as $i=>$r)
            $this->keepVars[$r] = RequestInfo::get($r);
    }
