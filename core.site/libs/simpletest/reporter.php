...
class JetReporter extends SimpleReporter {

	private $jetData = array();

    function JetReporter() {
        $this->SimpleReporter();
    }
    ...
    function paintFooter($test_name) 
	{
		$this->jetData['result'] = array(
			'fail_count' => $this->getFailCount(),
			'exceptions_count' => $this->getExceptionCount(),
			'progress' => $this->getTestCaseProgress(),
