...
Quote				: "Цитата",
//Quote Dialog
DlgQuoteTitle		: "Свойства цитаты",
DlgQuoteName		: "Имя автора",

InsertQuoteLbl		: "Вставить цитату",
InsertQuote			: "Вставить цитату",
Note				: "Нота",
//Note Dialog
DlgNoteTitle		: "Свойства ноты",
DlgNoteName			: "Имя автора",

InsertNoteLbl		: "Вставить заметку",
InsertNote			: "Вставить заметку",
...
// File Dialog
DlgFileTitle 		: "Вставка файла",
DlgFileInfoTab		: "Выберите папку",
// Image Dialog
DlgImgTitle			: "Свойства изображения",
DlgImgInfoTab		: "Вставка изображения",
