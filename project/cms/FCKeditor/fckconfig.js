...
//nop: список css редактора в обратном порядке
FCKConfig.EditorAreaCSS = 
	[
		'/redarmy.nop/skins/design/css/control.css',
		'/redarmy.nop/skins/design/css/screen.css',
		'/redarmy.nop/skins/design/css/all.css',
		'/redarmy.nop/skins/design/css/inner.css',
		'/redarmy.nop/skins/design/css/custom.css',
		'/redarmy.nop/skins/design/css/default.css',
		FCKConfig.BasePath + 'css/fck_editorarea.css',
	];

FCKConfig.getCss = function ()
{
	var ret="";
	for (var i=FCKConfig.EditorAreaCSS.length-1; i>=0; i--)
	{	
		ret+='<link href="'+FCKConfig.EditorAreaCSS[i]+'" rel="stylesheet" type="text/css" />';
		//alert (FCKConfig.EditorAreaCSS[i])
	}
	return ret;
}
...
FCKConfig.BaseHref = '' ;
FCKConfig.CmsBasePath = '/redarmy.nop/cms/';
...
FCKConfig.ToolbarSets["Default"] = [
	...
	'/',
	['Link','Unlink','Anchor'],
	['Table','Quote','Note','Image','File','FontFormat','SpecialChar'],//'Flash','Rule','Smiley','PageBreak','UniversalKey',
