...
// прочие настройки
config_set($self, 'cache_dir',  $_base_dir.'cache/'.$self->app_name.'/'); // (+) or "../project.zcache/" -- куда сложен кэш
...
config_set($self, 'tpl_root_dir',  $_base_dir.$_app_name."skins/");

config_set($self, 'jetstyle_email',  "admin@jetstyle.ru");
