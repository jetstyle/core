    ...
    */
    ...
    function parseAddressList($address = null, $default_domain = null, $nest_groups = null, $validate = null, $limit = null)
    {
        ...
        for ($i = 0; $i < count($this->addresses); $i++){
            ...
            if (!$this->nestGroups) {
                $this->structure = array_merge((array)$this->structure, (array)$return);
            } else {
    ...
    function _validateAddress($address)
    {
        ...
        // Flat format
            ...
            if ($is_group) {
                $structure = array_merge((array)$structure, (array)$addresses);
            } else {
                $structure = $addresses;
            }
        }
    ...
    function _validateRouteAddr($route_addr)
    {
        ...
        $return = array_merge((array)$return, (array)$addr_spec);
        return $return;
    }
